...
var StackMachine = function(bytecode) {
  ...
  this.executeInstruction = function() {
    ...
    var istore = this.bytecode.istore[pc];

    this.programCounter++;

    var opcode = opcodes.getOpcode(istore);
    var op1 = opcodes.getOp1(istore);
    var op2 = opcodes.getOp2(istore);
    ...
    switch (opcode) {
      ...
      case opcodes.ENT:
        ...
        for (var j = this.stackPointer; j < address; j++) {
          this.dataStore[j] = 0;
        }
