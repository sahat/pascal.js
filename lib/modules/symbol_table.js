...
var SymbolTable = function(parentSymbolTable) {
  ...
  this.addSymbol = function(name, nodeType, type) {
    var address = opcodes.MARK_SIZE + this.totalParameterSize + this.totalVariableSize;
    this.totalVariableSize += 1;
    var symbol = new Symbol(name, type, address);
